...
image::images/add.png[Operator Backed]

* Choose `Kafka`

image::images/add-kafka.png[Kafka]

* And click on `Create` button

image::images/kafka-create.png[Kafka] 
...
image::images/kafka-create-3.png[Kafka]

Go to the `Pods` and look all the pods running that you have, you must have 3 zookeeper, 3 kafka nodes and and `my-cluster-entity` operator running with `Ready` status.
