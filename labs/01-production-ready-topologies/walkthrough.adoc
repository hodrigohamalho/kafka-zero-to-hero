:walkthrough: Production-ready topologies: sizing and persistence
:codeready-url: {che-url}
:openshift-url: {openshift-host}
:user-password: openshift

= Lab 01 - Production-ready topologies: sizing and persistence

Explore how to use AMQ Streams for configuring a Kafka cluster for production usage, in particular sizing and persistence settings.
